        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="space-y-4 text-foreground/80">
                ...
                <p>We collect information you provide directly to us when you create an account, such as your name and email address. We also collect log data about your use of the services. This is a placeholder document and is not legally binding.</p>

                <h2 className="text-2xl font-semibold pt-4">2. How We Use Information</h2>
                <p>We use the information we collect to provide, maintain, and improve our services. We do not share your personal information with third parties except as described in this policy or with your consent.</p>

                <h2 className="text-2xl font-semibold pt-4">3. Data Storage</h2>
                <p>Your information is stored on secure servers. We take reasonable measures to protect your information from loss, theft, misuse, and unauthorized access.</p>
