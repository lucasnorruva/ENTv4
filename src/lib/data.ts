...
export let products: Product[] = [
  {
    ...
    status: 'Published',
    lastUpdated: new Date(new Date(now).setHours(now.getHours() - 1)).toISOString(),
    compliancePathId: 'cp-electronics-01',
    manualUrl: 'https://example.com/manuals/smart-watch-s5.pdf',
    declarationOfConformity: "This is a mock declaration of conformity for the Eco-Friendly Smart Watch. It adheres to all relevant EU standards.",
    materials: [
      { name: 'Recycled Aluminum', percentage: 60, recycledContent: 100, origin: 'Germany' },
      { name: 'Gorilla Glass', percentage: 15, recycledContent: 0, origin: 'USA' },
      { name: 'Silicone', percentage: 25, recycledContent: 50, origin: 'South Korea' },
    ],
    manufacturing: { facility: 'Eco-Factory 1', country: 'Germany', emissionsKgCo2e: 15.5 },
    certifications: [
    ...
    sustainability: {
      ...
      social: 80,
      governance: 85,
      summary: 'Excellent use of recycled materials and strong compliance record. Repairability score is high, contributing positively.',
      isCompliant: true,
    },
    qrLabelText: 'Verified for sustainability and made with 100% recycled aluminum.',
