...
export let products: Product[] = [
  {
    ...
    certifications: [{name: "CE", issuer: "TÜV SÜD"}, {name: "FCC", issuer: "FCC"}, {name: "ISO 14001", issuer: "BSI"}],
  ...
  },
  {
    ...
    materials: [
      { name: 'Organic Cotton', percentage: 100, recycledContent: 0, origin: "India" },
    ],
    certifications: [{name: "GOTS", issuer: "Control Union"}, {name: "Fair Trade", issuer: "Fairtrade International"}],
    sustainability: {
      score: 92,
      environmental: 95,
      social: 98,
    ...
    lastUpdated: new Date(new Date(now).setDate(now.getDate() - 4)).toISOString(),
    verificationStatus: 'Verified',
    endOfLifeStatus: 'Active',
    isProcessing: false,
  },
  {
    ...
    sustainability: {
        ...
        gaps: [{regulation: "EU Leather Goods Standard", issue: "Contains banned substance: Lead-based dye"}]
    },
    isProcessing: false,
  },
  {
    ...
    productDescription: 'A professional-grade quadcopter with a 4K camera and 30-minute flight time. Submitted for review.',
    productImage: 'https://placehold.co/600x400.png',
    category: 'Electronics',
    supplier: 'Eco Innovate Ltd.',
    status: 'Draft',
    materials: [{ name: 'Carbon Fiber' }, { name: 'Plastic' }, { name: 'Lithium Battery' }],
    ...
    lastUpdated: new Date(new Date(now).setHours(now.getHours() - 12)).toISOString(),
